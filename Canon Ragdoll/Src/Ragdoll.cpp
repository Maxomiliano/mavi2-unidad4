...
Ragdoll::Ragdoll(b2World* world, const b2Vec2& position)
{
	...
	b2Vec2 leftArmOffset(-2.5f, 0.0f);
	b2Vec2 rightArmOffset(2.5f, 0.0f);
	b2Vec2 leftLegOffset(-1.5f, 5.0f);
	b2Vec2 rightLegOffset(1.5f, 5.0f);
	...
	torsoBody = Box2DHelper::CreateRectangularDynamicBody(world, 4, 9, density, friction, restitution);
	torsoBody->SetTransform(position + torsoOffset, 0.0f);

	leftArmBody = Box2DHelper::CreateRectangularDynamicBody(world, 1, 6, density, friction, restitution);
	leftArmBody->SetTransform(position + leftArmOffset, 0.0f);

	rightArmBody = Box2DHelper::CreateRectangularDynamicBody(world, 1, 6, density, friction, restitution);
	rightArmBody->SetTransform(position + rightArmOffset, 0.0f);

	leftLegBody = Box2DHelper::CreateRectangularDynamicBody(world, 1, 6, density, friction, restitution);
	leftLegBody->SetTransform(position + leftLegOffset, 0.0f);

	rightLegBody = Box2DHelper::CreateRectangularDynamicBody(world, 1, 6, density, friction, restitution);
	rightLegBody->SetTransform(position + rightLegOffset, 0.0f);


	//Cabeza y torso
	b2Vec2 headAnchor = position + headOffset + b2Vec2(0.0f, 1.0f);
	b2Vec2 centerAnchor = position + torsoOffset + b2Vec2(0.0f, -4.0f);
	...
	b2Vec2 centerAnchorLA = position + torsoOffset + b2Vec2(-2.0f, -4.0f);
	b2Vec2 leftArmAnchor = position + leftArmOffset + b2Vec2(0.0f, -3.0f);
	...
	b2Vec2 centerAnchorRA = position + torsoOffset + b2Vec2(2.0f, -4.0f);
	b2Vec2 rightArmAnchor = position + rightArmOffset + b2Vec2(0.0f, -3.0f);
	...
	b2Vec2 centerAnchorLL = position + torsoOffset + b2Vec2(-1.0f, 4.0f);
	b2Vec2 leftLegAnchor = position + leftLegOffset + b2Vec2(0.0f, -3.0f);
	...
	b2Vec2 centerAnchorRL = position + torsoOffset + b2Vec2(1.0f, 4.0f);
	b2Vec2 rightLegAnchor = position + rightLegOffset + b2Vec2(0.0f, -3.0f);
