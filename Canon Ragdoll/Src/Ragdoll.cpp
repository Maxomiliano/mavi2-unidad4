...
Ragdoll::Ragdoll(b2World* world, const b2Vec2& position)
{
	...
	leftLegBody->SetTransform(b2Vec2(24.0f, 42.8f), 0.0f);

	rightLegBody = Box2DHelper::CreateRectangularDynamicBody(world, 1, 6, density, friction, restitution);
	rightLegBody->SetTransform(b2Vec2(26.5f, 42.8f), 0.0f);


	//Cabeza y torso
	b2Vec2 headAnchor(25.0f, 30.5f);
	...
	b2Vec2 leftArmAnchor(22.5f, 32.5f);
	...
	b2Vec2 centerAnchorLL(23.5f, 39.0f);
	b2Vec2 leftLegAnchor(23.5f, 39.5f);
	...
	b2Vec2 centerAnchorRL(26.0f, 39.0f);
	b2Vec2 rightLegAnchor(26.0f, 39.5f);
